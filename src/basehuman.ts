...
const BASE_MAX : number = 10000;
// see: http://www.unicode.org/reports/tr18/#Line_Boundaries
const NEWLINE = /\r\n|[\n\v\f\r\x85\u2028\u2029]/g.compile();
const MAX_SHIFTABLE = Math.pow(2,32) - 1;

export interface IBaseHumanOptions {
    language : string,
    base : number,
    seperator : string
};
...
export class BaseHuman {
    private dict : string[] = [];
    private opt : IBaseHumanOptions = {
        language : "en",
        base : 1024,
        seperator : " "
    };
     ...
     * constructor
     */
    constructor(options : IBaseHumanOptions) {
